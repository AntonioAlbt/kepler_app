...
class MailWritePage extends StatefulWidget {
  ...
  const MailWritePage({super.key, this.to, this.subject, this.mail});
              ...
              children: [
                ElevatedButton.icon(
                  onPressed: () async {
                    ...
                    final (online, success) = await saveDraft(creds.lernSaxLogin!, creds.lernSaxToken!, subject: _subjectInputCtrl.text, to: recvKey.currentState!.chips, bodyPlain: _mailInputCtrl.text);
                ...
                FilledButton.icon(
                  onPressed: () async {
                    ...
                    if (recvKey.currentState!.chips.isEmpty) {
                      showSnackBar(text: "Empfänger nicht eingegeben!", error: true);
                      return;
                    }
                    if (_subjectInputCtrl.text == "") {
                      showSnackBar(text: "E-Mail hat keinen Betreff!", error: true);
                    ...
                    final (online, success) = await sendMail(creds.lernSaxLogin!, creds.lernSaxToken!, subject: _subjectInputCtrl.text, to: recvKey.currentState!.chips, text: _mailInputCtrl.text);
